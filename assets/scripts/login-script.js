...
loginFormElement.addEventListener("submit", function (event) {
  ...
  // Comment : Mendapatkan nlai dari masing-masing input (email dan password) ketika tombol ditekan
  ...
  // Comment : Mendapatkan bahwa nilai email dan password sesuai dengan nilai yang tersimpan.
